...
stator_slot_shaper = "trapezoidal_curved_corner" 
...
s_slot_width_r2=7  --w2 (slot opening width(smaller width))
...
rotor_shaper = "circular_slot" 

-- open or semi_closed or closed
rotor_type_slot="closed"

    

rotor_outer_radius=59         -- starting(slot) height from center
rotor_num_slots=23
rotor_slot_height=8                   --Total slot height ( for circular_slot the slot height and slot_width_r1 must be same)
...
--zero for rectangular and trapezoidal slots
r_arc_bottom=1--The radius of the semicircular arc at the bottom of the slot (keyhole curve) and 

slot_width_r1=8
slot_width_r2=0  --( zero for rectangular and circular slots), (input value for trapezoidal slots), (slot_width_r1*0.3 for key hole slot)
